...
export const VoiceRecognition: React.FC<VoiceRecognitionProps> = ({
	...
	const detectIntentWithRegionalPatterns = useCallback(
		(text: string, patterns: BrazilianRegionalPatterns): VoiceIntent => {
	...
	const extractFinancialEntities = useCallback(
		(text: string, patterns: BrazilianRegionalPatterns) => {
			const entities: any = {};
	...
	const getRegionalErrorMessage = useCallback(
		(error: string, patterns: BrazilianRegionalPatterns): string => {
