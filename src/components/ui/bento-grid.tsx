    ...
    <ul className="mt-2 space-y-1.5">
      {items.map((item, index) => (
        ...
        >
          ...
          <span className="text-sm text-foreground/70 dark:text-foreground/60">{item}</span>
        </motion.li>
      ))}
    </ul>
  )
      ...
      >
        ...
        >
          <div className="space-y-2 flex-1 flex flex-col">
            ...
            <p className="text-sm text-muted-foreground tracking-tight">{item.description}</p>
