...
function UserDropdown() {
  ...
  return (
    <div className="flex items-center gap-2 text-sm">
      <div className="w-8 h-8 rounded-full bg-gradient-to-r from-pix-primary to-pix-accent flex items-center justify-center text-white font-semibold">
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-pix-primary"></div>
      </div>
    )
  }
