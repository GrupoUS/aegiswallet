  ...
  return React.createElement('div', { 'data-testid': 'lgpd-compliance-audit-report' }, [
    ...
    React.createElement('div', { 'data-testid': 'executive-summary', key: 'executive-summary' }, [
      ...
      React.createElement('div', { key: 'summary-content' }, [
        React.createElement(
          'div',
          { 'data-testid': 'overall-compliance-score', key: 'overall-score' },
          [
    ...
    React.createElement('div', { 'data-testid': 'critical-issues', key: 'critical-issues' }, [
      ...
      criticalIssues.length === 0
        ? React.createElement(
            'div',
            { key: 'no-issues', style: { color: 'green', fontWeight: 'bold' } },
  ...
  describe('Audit Report Generation', () => {
    ...
    it('should calculate accurate compliance scores', async () => {
      ...
      await waitFor(() => {
        ...
        const score = parseInt(overallScore.textContent?.match(/(\d+)%/)?.[1] || '0', 10);
