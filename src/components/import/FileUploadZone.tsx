...
if (file.size > maxSizeMB * 1024 * 1024) return `Arquivo muito grande. Máximo: ${maxSizeMB}MB`;
...
<p className="text-sm text-muted-foreground">PDF ou CSV de extratos bancários (máx. {maxSizeMB}MB)</p>
</div>
</div>
)}
</div>
