...
--
-- File: src/db/migrations/XXXX_google_calendar_sync.sql
-- Replace XXXX with the next migration number in your sequence
...
COMMENT ON TABLE calendar_sync_settings IS 'Per-user synchronization settings and webhook configuration';
COMMENT ON TABLE calendar_sync_mappings IS 'Mapping between AegisWallet events and Google Calendar events';
