...
...((error as EnhancedApiError).details && { details: (error as EnhancedApiError).details }),
};
}
...
public error(message: string, error?: Error | EnhancedApiError, context?: Partial<ErrorLogContext>): void {
this.log('error', message, error, context);
}

public fatal(message: string, error?: Error | EnhancedApiError, context?: Partial<ErrorLogContext>): void {
...
...log,
...(log.error?.stack && !this.isDevelopment && {
error: {
...log.error,
...
private buildLgpdContext(message: string, error?: Error | EnhancedApiError): ErrorLogEntry['lgpd'] {
...
pattern.test(message) || (error?.message && pattern.test(error.message))
);
