  ...
  return (
    <div className="flex flex-col gap-4 p-8">
      ...
      <div className="flex gap-4 items-center">
        ...
        <NeumorphButton size="medium">
          Medium Button
        </NeumorphButton>
        
        <NeumorphButton size="large">
          Large Button
        </NeumorphButton>
      </div>
      
      <div className="flex gap-4 items-center">
        <NeumorphButton loading>
          Loading Button
        </NeumorphButton>
        
        <NeumorphButton disabled>
          Disabled Button
        </NeumorphButton>
