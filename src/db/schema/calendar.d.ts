 ...
 */
export declare const googleCalendarTokens: import('drizzle-orm/pg-core').PgTableWithColumns<{
  ...
  columns: {
    id: import('drizzle-orm/pg-core').PgColumn<
      {
        name: 'id';
        tableName: 'google_calendar_tokens';
        dataType: 'string';
        columnType: 'PgUUID';
        data: string;
        driverParam: string;
    ...
    refreshToken: import('drizzle-orm/pg-core').PgColumn<
      ...
      {}
    >;
    expiryTimestamp: import('drizzle-orm/pg-core').PgColumn<
      {
    ...
    scope: import('drizzle-orm/pg-core').PgColumn<
      ...
      {}
    >;
    googleUserEmail: import('drizzle-orm/pg-core').PgColumn<
      {
 ...
 */
export declare const calendarSyncSettings: import('drizzle-orm/pg-core').PgTableWithColumns<{
  ...
  columns: {
    userId: import('drizzle-orm/pg-core').PgColumn<
      {
        name: 'user_id';
        tableName: 'calendar_sync_settings';
        dataType: 'string';
        columnType: 'PgUUID';
        data: string;
        driverParam: string;
    ...
    syncDirection: import('drizzle-orm/pg-core').PgColumn<
      ...
      {}
    >;
    syncFinancialAmounts: import('drizzle-orm/pg-core').PgColumn<
      {
        name: 'sync_financial_amounts';
        tableName: 'calendar_sync_settings';
        dataType: 'boolean';
        columnType: 'PgBoolean';
        data: boolean;
      ...
      {}
    >;
    syncCategories: import('drizzle-orm/pg-core').PgColumn<
      {
    ...
    syncToken: import('drizzle-orm/pg-core').PgColumn<
      ...
      {}
    >;
    autoSyncIntervalMinutes: import('drizzle-orm/pg-core').PgColumn<
      {
 ...
 */
export declare const calendarSyncMapping: import('drizzle-orm/pg-core').PgTableWithColumns<{
  name: 'calendar_sync_mapping';
  schema: undefined;
  columns: {
    id: import('drizzle-orm/pg-core').PgColumn<
      {
        name: 'id';
        tableName: 'calendar_sync_mapping';
        dataType: 'string';
        columnType: 'PgUUID';
        data: string;
        driverParam: string;
    ...
    userId: import('drizzle-orm/pg-core').PgColumn<
      ...
      {}
    >;
    aegisEventId: import('drizzle-orm/pg-core').PgColumn<
      {
        name: 'aegis_event_id';
        tableName: 'calendar_sync_mapping';
        dataType: 'string';
 ...
 */
export declare const calendarSyncAudit: import('drizzle-orm/pg-core').PgTableWithColumns<{
  name: 'calendar_sync_audit';
  schema: undefined;
  columns: {
    id: import('drizzle-orm/pg-core').PgColumn<
      {
        name: 'id';
        tableName: 'calendar_sync_audit';
        dataType: 'string';
        columnType: 'PgUUID';
        data: string;
        driverParam: string;
