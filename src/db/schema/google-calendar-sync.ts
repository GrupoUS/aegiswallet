...
export const syncStatusEnum = pgEnum('sync_status', ['synced', 'pending', 'error', 'conflict']);

export const syncSourceEnum = pgEnum('sync_source', ['aegis', 'google', 'manual']);
...
export const syncQueueDirectionEnum = pgEnum('sync_queue_direction', ['to_google', 'from_google']);
