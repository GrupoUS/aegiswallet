...
export function useProfile() {
  ...
  const { mutate: updateProfile, isPending: isUpdatingProfile } = trpc.profiles.updateProfile.useMutation({
    onSuccess: (data) => {
  ...
  const { mutate: updatePreferences, isPending: isUpdatingPreferences } = trpc.profiles.updatePreferences.useMutation({
    onSuccess: (data) => {
