...
const SuggestedQuestions = ({ onQuestionSelect }: SuggestedQuestionsProps) => {
  const questions = [
    {
      ...
      text: "Analise meus gastos do mês atual",
      category: "Análise"
    },
    {
      icon: <CreditCard className="h-4 w-4" />,
      text: "Gastei R$ 150,00 no supermercado hoje",
      category: "Transação"
    },
    {
      icon: <PiggyBank className="h-4 w-4" />,
      text: "Crie um orçamento personalizado para mim",
      category: "Orçamento"
    },
    {
      icon: <Calendar className="h-4 w-4" />,
      text: "Mostre minhas contas próximas ao vencimento",
      category: "Lembretes"
    },
    {
      icon: <TrendingUp className="h-4 w-4" />,
      text: "Como está minha saúde financeira?",
      category: "Insights"
    },
    {
      icon: <Target className="h-4 w-4" />,
      text: "Dicas para economizar mais dinheiro",
      category: "Dicas"
    },
    {
      icon: <Wallet className="h-4 w-4" />,
      text: "Qual categoria eu mais gasto?",
      category: "Análise"
    },
    {
      icon: <AlertCircle className="h-4 w-4" />,
      text: "Recebi R$ 3000,00 de salário",
      category: "Transação"
    }
  ];
  ...
  const categories = {
    ...
    "Transação": "bg-green-50 dark:bg-green-950/20 border-green-200 dark:border-green-800",
    "Orçamento": "bg-purple-50 dark:bg-purple-950/20 border-purple-200 dark:border-purple-800",
    "Lembretes": "bg-orange-50 dark:bg-orange-950/20 border-orange-200 dark:border-orange-800",
    "Insights": "bg-pink-50 dark:bg-pink-950/20 border-pink-200 dark:border-pink-800",
    "Dicas": "bg-yellow-50 dark:bg-yellow-950/20 border-yellow-200 dark:border-yellow-800"
  };
