			...
			<DialogContent className="sm:max-w-[425px]" role="dialog" aria-modal="true">
				...
				>
					<div className="grid gap-2">
						...
						/>
						<span id={amountHelpId} className="sr-only">
					...
					<div className="grid gap-2">
						<Label htmlFor={accountSelectId}>
							Conta {actionType === 'transfer' ? 'de Origem' : ''}
						</Label>
					...
					<div className="grid gap-2">
						<Label htmlFor={descInputId}>Descrição (Opcional)</Label>
						<Input
							id={descInputId}
