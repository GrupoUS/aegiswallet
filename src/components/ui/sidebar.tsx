  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'group-data-[collapsible=icon]:hidden',
        showOnHover &&
          'group-focus-within/menu-item:opacity-0 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 peer-data-[active=true]/menu-button:text-sidebar-accent-foreground'
      )}
      {...props}
    />
  );
...
export { SidebarContent as SidebarBody };
